...
Khi phát triển theo yêu cầu người dùng, áp dụng [quy tắc plan và tiết kiệm quota](.agents/rules/development.md): một plan tổng thể, chia việc không trùng cho các subagent được phép, micro-plan cho lỗi phát sinh và kiểm thử có mục tiêu. Quy tắc này không bỏ các cổng duyệt hoặc khóa integrity của job.
