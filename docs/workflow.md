...
|---|---|---|
| content | Kịch bản Việt/Anh, số cảnh, nhân vật, ý bắt buộc, thời lượng ước tính | Người hoặc máy duyệt nội dung |
| media | Toàn bộ cảnh/ảnh, ảnh nhân vật đã đăng ký, WAV Việt/Anh, phụ đề, thời lượng thật | Người hoặc máy duyệt chung |
...
```bash
python3 pilot.py new auto-001 --brief examples/m1/brief.json --mode auto
...
Mỗi ví dụ là một lựa chọn riêng, không chạy nối tiếp trên cùng revision. Sửa nội dung ở draft/content.json. Thay brief qua revise-brief, không sửa brief đã lưu. Thay ảnh giữ audio hợp lệ; mọi thay đổi media buộc duyệt lại media trước dựng. Không sửa file đã duyệt.
...
Việt: Minh Quân Pro / VieNeu v3 Turbo ONNX FP32. Anh: Alba / Pocket TTS CPU INT8, tốc độ gốc. Bản 9:16 có tiếng Việt/phụ đề; 16:9 có tiếng Anh, timeline riêng và ẩn phụ đề. Dual tạo cả hai. Thời lượng kiểm tra theo brief, không nới bằng config. Tạo video AI bị khóa.
